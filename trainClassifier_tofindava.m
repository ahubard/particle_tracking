function [trainedClassifier, validationAccuracy] = trainClassifier_tofindava(trainingData)
...
% Auto-generated by MATLAB on 11-Aug-2016 13:28:17
...
splitMatricesInTableFcn = @(t) [t(:,setdiff(t.Properties.VariableNames, {'row'})), array2table(table2array(t(:,{'row'})), 'VariableNames', {'row_1', 'row_2'})];
