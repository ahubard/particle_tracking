function  order = separate_avalanches(folder, En, D, filenb)
...
x_boundary_cuttof = xo-sqrt(R^2-ydiff2_max)+3/4*D;

%% Get particles positions

displacement_file = sprintf('Displacement_i.mat',filenb);
